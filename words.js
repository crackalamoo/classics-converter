...
const samples = [
    {'name':'numbers', 'in':'dvau triiNi panca sapta aSTa dasha shatam laksa', 'langs':['hi']},
    {'name':'numbers', 'in':'dvau panca sapta aSTa dasha shatam laksa', 'langs':['pa']},
    {'name':'numbers', 'in':'panca sapta aSTa dasha viMshati laksa', 'langs':['mr']},
    {'name':'time', 'in':'adya raatri sthita dina dvau-prahara saMdhya dina-rajanii', 'langs':['hi']},
    {'name':'merchant', 'in':'deshiiya shreSTi kRta saartha yaH aagata sthaa pRccha dadiiya kaHpunar sthaa', 'langs':['hi']},
    {'name':'body parts', 'in':'hasta karNa aksa shiras paada mukha apara danta vaala galla', 'langs':['hi']},
    {'name':'body parts', 'in':'hasta karNa aksa shiras danta vaala haDDikaa', 'langs':['pa']},
    {'name':'body parts', 'in':'hasta karNa paada danta kesha man\'yaa jihvaa galla haDDa', 'langs':['mr']},
    {'name':'moon', 'in':'puuraka candra duura apara priyakaaraka sthaa adya raatri', 'langs':['hi']},
    {'name':'moon', 'in':'puuraka candra duura adya', 'langs':['pa']},
    {'name':'food', 'in':'ghRt jiiraka shatapuSpa dhaaneyaka lashuna roTika daala pulaaka aamra caNaka phala phulla kadala gaarjara guDa pattra naarikela paalakyaa tila parNa parpaTa khaad pipaasa paaniiya dugdha lasikaa', 'langs':['hi']},
    ...
    {'name':'food', 'in':'paanem caaseum viinum ovum pira ceepullam ostream apium lactem gelaatum carnem pullum friictum saal fariinam in furnum', 'langs':['es']},
    {'name':'food', 'in':'paanem caaseum viinum ovum friictum pira ceepullam lactem carnem saal in furnum', 'langs':['pt']},
    {'name':'food', 'in':'paanem fruuctum viinum ovum friictum pira lactem furnum fariinam', 'langs':['fr']},
    {'name':'food', 'in':'paanem caaseum viinum ovum lactem gelaatum carnem pullum saal pastam oliiva furnum fariinam', 'langs':['it']},
    {'name':'pronouns', 'in':'tuu ille illa illoos illaas mee tee noos voos tuii suii nostrum vostrum quid', 'langs':['es']},
    ...
    {'name':'misc', 'in':'faminem muutaare metum baasium praemium reegulam podium multum folia pugnum cognaatum speculum portam iinsulam super montaaneam corpum bonum bonam benem populum viridim sitim pacem fiilium veeritaatem magistrum camiinum', 'langs':['es']},
    ...
    {'name':'misc', 'in':'muutaare metum baasium praemium reegulam multum folia cognaatum speculum portam super montaaneam corpum bonum bonam benem viridim sitim pacem fiilium veeritaatem caelum', 'langs':['pt']},
    {'name':'misc', 'in':'fluumen folia portam baasium montaaneam corpum bonum bonam steella viridim corem', 'langs':['it']},
];
